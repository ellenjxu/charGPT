...
input_file_path = os.path.join(os.path.dirname(__file__), 'enwik8.zip')
...
data = zipfile.ZipFile(input_file_path).read('enwik8').decode('utf-8')
...
val_data = data[90000000:90000000+5000000]
test_data = data[90000000+5000000:]
